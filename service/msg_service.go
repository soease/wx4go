...
/* 获取群中的用户信息
   POST:https://wx.qq.com/cgi-bin/mmwebwx-bin/webwxbatchgetcontact?
        type=ex&
        r=1453373586582&
        pass_ticket=cNQtWm5HAlkezd4WDrmrb6TBQYtkdHM4jaqbSWWYCT0EzIWzxBLHTu6Rb4fPw%252Fhf
   BODY:{
	"BaseRequest":{"Uin":2684027137,"Sid":"rnggO94JNo8B3Irp","Skey":"@crypt_3bb2969_890811a1e096f98662389b04dac3dcb8","DeviceID":"e559659465724952"},
	"Count":1,
	"List":[{"UserName":"@83cdf89d8ae7bf82d1fba26693b4952f","EncryChatRoomId":"@@8432d9b1c96038e5229185af62caa626add1a6b87554eb91cc5f5b63a207c8b3"}]
   }

*/
func GetGroupUserName(loginMap *m.LoginMap, UserID string, GroupID string) string {
	var uu []m.UserList
	wxUserInfo := m.UserInfo{}

	uu = append(uu, m.UserList{UserName: UserID, RoomId: GroupID})
